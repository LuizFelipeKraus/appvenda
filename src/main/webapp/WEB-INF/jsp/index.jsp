<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
			<div class="container-fluid">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="/moveis/lista">Moveis</a></li>
					<li class="nav-item"><a class="nav-link" href="/eletrodomestico/lista">Eletrodomestico</a></li>
				</ul>
		...
		<div class="container mt-3">
			...
			<span class="badge rounded-pill bg-success">Moveis: ${qtdeMoveis}</span>
			<span class="badge rounded-pill bg-danger">Eletrodomestico: ${qtdeEletrodomestico}</span>
